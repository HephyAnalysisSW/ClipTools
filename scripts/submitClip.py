...
from proxyHelper import read_from_subprocess
...
parser.add_option("--walltime",           dest="walltime",           default=None,       type=str,                 help="Walltime in format DD-HH:MM:SS or HH:MM:SS. Default is 8h!")
...
if options.walltime:
    ...
    else:                    options.queue = "short"  # <= 8 hours
